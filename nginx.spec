...
Patch1000:         remove-redhat-index-references.patch
Patch1001:         remove-redhat-404-references.patch
Patch1002:         remove-redhat-50x-references.patch
...
patch %{SOURCE100} %{PATCH1000}
install -p -m 0644 %{SOURCE100} \
    %{buildroot}%{_datadir}/nginx/html
install -p -m 0644 %{SOURCE101} %{SOURCE102} \
    %{buildroot}%{_datadir}/nginx/html
patch %{SOURCE103} %{PATCH1001}
patch %{SOURCE104} %{PATCH1002}
...
%changelog
* Thu Sep 19 2019 Lukas Lemes <lukas.lemes@oracle.com> - 1:1.14.1-9.0.1
